<x-app-layout>
    ...
    <div class="bg-gray-100">
        <div class="bg-main-color w-full text-gray-800">
            ...
            <x-slot name="header">
                ...
                <div x-data="{ open: false }"
                    ...
                    <div class="flex flex-row items-center justify-between p-4">
                        ...
                        <h2 class="text-xl font-semibold leading-tight text-gray-800">
                            <a href="#"
                                class="focus:shadow-outline rounded-lg text-xl font-semibold uppercase leading-tight tracking-widest text-gray-800 focus:outline-none">
                                {{ $user->firstname }}</a>
                        </h2>
                    ...
                    <nav :class="{ 'flex': open, 'hidden': !open }"
                        ...
                        <div @click.away="open = false" class="relative" x-data="{ open: false }">
                            <button @click="open = !open"
                                class="focus:shadow-outline mt-2 flex w-full flex-row items-center space-x-2 bg-transparent px-4 py-2 text-left text-sm font-semibold hover:bg-gray-200 focus:bg-blue-800 focus:outline-none md:mt-0 md:ml-4 md:inline md:w-auto">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                ...
                                <div
                                    class="border-main-color rounded-sm border bg-white py-2 text-sm text-blue-800 shadow-sm">
                                    <a class="focus:shadow-outline mt-2 block bg-white px-4 py-2 text-sm hover:bg-indigo-100 focus:bg-gray-200 focus:text-gray-900 focus:outline-none md:mt-0"
                                        href="#">Settings</a> <a
                                        ...
                                        href="{{ route('admin.users.edit', $user->id) }}">Edit profile</a>
                                    <a class="focus:shadow-outline mt-2 block bg-white px-4 py-2 text-sm hover:bg-indigo-100 focus:bg-gray-200 focus:text-gray-900 focus:outline-none md:mt-0"
                                        href="#">Help</a>
            ...
            <div class="no-wrap md:-mx-2 md:flex">
                ...
                <div class="w-full md:mx-2 md:w-3/12">
                    ...
                    <div class="border-t-4 border-green-400 bg-white p-3">
                        ...
                        <h1 class="my-1 text-xl font-bold leading-8 text-gray-900">{{ $user->fullname() }}</h1>
                        <h3 class="font-lg text-semibold leading-6 text-gray-600">Owner at Her Company Inc.</h3>
                        ...
                        <ul
                            ...
                            <li class="flex items-center py-3">
                                ...
                                <span class="ml-auto"><span
                                        class="rounded bg-green-500 py-1 px-2 text-sm text-white">Active</span></span>
                            </li>
                            <li class="flex items-center py-3">
                ...
                <div class="mx-2 h-64 w-full md:w-9/12">
                    ...
                    <div class="rounded-sm bg-white p-3 shadow-sm">
                        ...
                        <button
                            class="focus:shadow-outline hover:shadow-xs my-4 block w-full rounded-lg p-3 text-sm font-semibold text-blue-800 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none">Show
